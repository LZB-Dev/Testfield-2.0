...
public class GunScriptableObject : ScriptableObject
{
    ...
    public void Spawn(Transform Parent, MonoBehaviour ActiveMonoBehaviour)
    {
        ...
        LastShootTime = 0; // in editor this will not be properly reset, in build it will
    ...
    private IEnumerator PlayTrail(Vector3 StartPoint, Vector3 EndPoint, RaycastHit Hit)
    {
        ...
        {
            //SurfaceManager.Instance.HandleImpact(                               //SurfaceManager is custom script created by LLama
            //    Hit.transform.gameObject, EndPoint, Hit.normal, ImpactType, 0); //The same goes for ImpactType
        }
